...
def getDatanew(filePath, resize_format=(100, 100), colorType=cv2.IMREAD_COLOR, resize_interpolation=cv2.INTER_NEAREST,
    ...
    model = VGG16(include_top=True, weights='imagenet')
    dense_result = Model(inputs=model.input, outputs=model.get_layer("block5_pool").output)  ####分类层的前一层
...
import time
# 获取数据
filePath_train = 'E:/lzc/20220417/gaiming/gaiming/train4.txt'
filePath_test = 'E:/lzc/20220417/gaiming/gaiming/test4.txt'
...
# 设置参数
N1 = 36 # # of nodes belong to each window 5   {'N1': 2.0, 'N2': 64.0, 'N3': 18278.0
N2 = 10  # # of windows -------Feature mapping layer 7   94   6 48 25514
N3 = 540 # # of enhancement nodes -----Enhance layer 200 2083
